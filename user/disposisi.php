                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <section class="content invoice">
					  ...
					  <h3>Isi Surat:</h3>
                      <div class="row">
                        <embed src="<?php echo $row_dis->foto;?>" type="application/pdf" width="100%" height="600px">
                        <!-- /.col -->
                      </div>
                      <!-- /.row -->
					  <?php
					  ...
					  if(isset($_POST['kirim'])){
					  	$simpan_dis=mysqli_query($link,"INSERT INTO disposisi (no_surat,tgl_dispo,ditujukan,ket,status) VALUE ('$_POST[no_surat]','$now','$_POST[kepada]','$_POST[isi]','otomatis')");
						if($simpan_dis){
					  ...
					  <div class="row">
						...
						<div class="col-xs-6">
                          ...
                          <div class="table-responsive">
                            <textarea class="form-control" rows="10" name="isi" cols="" rows="">Instruksi:</textarea>
                          </div>
                        </div>
                        <!-- /.col -->
                      </div>
