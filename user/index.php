                      ...
                      <li>
                        <div class="block">
                          <div class="block_content">
                            <h2 class="title">
                                              <a href="">Surat Datang dari <?php echo $rows->asal_surat;?>, surat ini <?php echo $rows->sifat;?></a>
                                          </h2>
                            <div class="byline">
                              <span><?php echo "<time class='timeago' datetime='$rows->tgl_terima' title='$rows->tgl_terima'>"; ?></span> by <a><?php echo $rows->pencatat;?></a>
                            </div>
                            <p class="excerpt"><?php echo "Surat Masuk datang dari ".$rows->asal_surat." , surat ini bersifat ".$rows->sifat.", dengan perihal ".$rows->perihal;?>… <a>Read&nbsp;More</a>
                            </p>
                          </div>
                        </div>
                      </li>
